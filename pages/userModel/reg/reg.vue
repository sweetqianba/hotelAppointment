<template>
	<view class="content">
		...
		<view class="cu-form-group">
			...
			<input type="text" v-model="nickName" placeholder="昵称" class='radius' name='input'></input>
		</view>
		<view class="padding flex flex-direction">
			<button class='cu-btn bg-blue lg' @tap="register">注册</button>
		</view>
	</view>
</template>
